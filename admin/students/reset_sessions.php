...
require_once '../includes/db_connect.php';  // Make sure this points to the correct path
session_start();
...
if (!isset($_GET['student_id']) || empty($_GET['student_id'])) {
    ...
    header('Location: ../sitin/current_sitin.php');
    exit();
}

// Get the student ID
$student_id = $_GET['student_id'];
$redirect_page = isset($_GET['redirect']) ? $_GET['redirect'] : '../sitin/current_sitin.php';
