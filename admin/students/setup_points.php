...
if ($trigger_check && $trigger_check->num_rows > 0) {
    ...
    if ($drop_trigger) {
        echo "<p>Existing trigger dropped successfully. Points conversion will be handled by PHP code.</p>";
    } else {
        echo "<p>Error dropping trigger: " . $conn->error . "</p>";
    }
} else {
    echo "<p>No trigger exists. Points conversion will be handled by PHP code.</p>";
}
