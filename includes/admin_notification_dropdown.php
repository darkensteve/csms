...
// Only process if admin is logged in
if ($admin_id) {
    // Get unread notifications count
    $unread_count = count_unread_notifications($admin_id, 'admin');
    
    // Get recent notifications (limit to 5)
    $notifications = get_notifications($admin_id, 'admin', false, 5);
...
if (!window.notificationScriptLoaded) {
    ...
    function markAllAsRead() {
        ...
        xhr.send('mark_all=1&type=admin');
    }
